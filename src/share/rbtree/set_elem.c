...
struct set_node *set_rbinsert(struct set_tree *tree,void *data, int (*cmp)(const void *, const void *))
{
    ...
    /* Add new node and rebalance tree  */
    struct set_node *node_t=(struct set_node *)RBMALLOC(sizeof(struct set_node));
    set_node_init(node_t);
    node_t->data=data;
    rb_link_node(&node_t->node, parent, new_node);
    rb_insert_color(&node_t->node, root);
...
struct set_node *set_rberase_EX(struct set_tree *tree,struct set_node *elem,void *param,void (*freec)(void*,void*))
{
    struct rb_root *root = &tree->root;
    struct rb_node *n = &elem->node;
    struct rb_node *t = rb_next(n);
...
struct set_node *set_rberase_EX_mc(struct set_tree *tree,struct set_node *elem,void *param,void (*freec)(void*,void*))
{
    struct rb_node *n,*t;
    struct rb_root *root;
    set_tree_lock(tree);
